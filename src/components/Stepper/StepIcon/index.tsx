...
type stepnumber = 2 | 3 | 4 | 5 | 6 | 7 | 8 | 9 | 10;
    ...
    >
      {height > 650 && (
        <>
          ...
          {!props.isFirstStep && (
            <View style={[styles.leftBar, s[stepCount]]} />
          )}
...
const s = StyleSheet.create({
  2: { marginLeft: -90, width: 120 },
  3: { marginLeft: -55, width: 90 },
  4: { marginLeft: -35, width: 70 },
  5: { marginLeft: -20, width: 50 },
  6: { marginLeft: -10, width: 47 },
  7: { marginLeft: -1, width: 29 },
  8: { marginLeft: 3, width: 30 },
  9: { marginLeft: 10, width: 20 },
  10: {},
});
