...
const stripeClient = (key: any) => {
  return {
    createToken: async (details: any) => {
...
function _findType(details: any, keys: any) {
...
function _convertDetails(type: any, details: any) {
  var convertedDetails: any = {};
...
async function _parseJSON(token: any) {
...
function _createTokenHelper(details: any, key: any) {
